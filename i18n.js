...
const i18n = {
    ...
    fallbackTranslations: {
        en: {
            ...
            dropzone: { title: "Drop images here", description: "Drag & drop files or click to browse.", formats: "Supports JPG, PNG, WebP, AVIF, GIF, BMP, TIFF, SVG, ICO, HEIC, JPEG 2000, JPEG XL, RAW", hint: "You can select multiple files at once" },
            results: { title: "Results", fileInfo: "File Info", state: "State", optimization: "Optimization", action: "Action", download: "Download", downloadAll: "Download All", clear: "Clear", preview: "Preview", remove: "Remove" },
        ...
        de: {
            ...
            dropzone: { title: "Bilder hier ablegen", description: "Dateien hierher ziehen oder klicken zum Durchsuchen.", formats: "Unterstützt JPG, PNG, WebP, AVIF, GIF, BMP, TIFF, SVG, ICO, HEIC, JPEG 2000, JPEG XL, RAW", hint: "Sie können mehrere Dateien gleichzeitig auswählen" },
            results: { title: "Ergebnisse", fileInfo: "Dateiinfo", state: "Status", optimization: "Optimierung", action: "Aktion", download: "Herunterladen", downloadAll: "Alle herunterladen", clear: "Leeren", preview: "Vorschau", remove: "Entfernen" },
        ...
        fr: {
            ...
            dropzone: { title: "Déposez les images ici", description: "Glissez-déposez ou cliquez pour parcourir.", formats: "Supporte JPG, PNG, WebP, AVIF, GIF, BMP, TIFF, SVG, ICO, HEIC, JPEG 2000, JPEG XL, RAW", hint: "Vous pouvez sélectionner plusieurs fichiers à la fois" },
            results: { title: "Résultats", fileInfo: "Fichier", state: "État", optimization: "Optimisation", action: "Action", download: "Télécharger", downloadAll: "Tout télécharger", clear: "Effacer", preview: "Aperçu", remove: "Supprimer" },
        ...
        es: {
            ...
            dropzone: { title: "Arrastra imágenes aquí", description: "Arrastra y suelta o haz clic para explorar.", formats: "Soporta JPG, PNG, WebP, AVIF, GIF, BMP, TIFF, SVG, ICO, HEIC, JPEG 2000, JPEG XL, RAW", hint: "Puedes seleccionar varios archivos a la vez" },
            results: { title: "Resultados", fileInfo: "Archivo", state: "Estado", optimization: "Optimización", action: "Acción", download: "Descargar", downloadAll: "Descargar todo", clear: "Limpiar", preview: "Vista previa", remove: "Eliminar" },
        ...
        it: {
            ...
            dropzone: { title: "Trascina le immagini qui", description: "Trascina e rilascia o clicca per sfogliare.", formats: "Supporta JPG, PNG, WebP, AVIF, GIF, BMP, TIFF, SVG, ICO, HEIC, JPEG 2000, JPEG XL, RAW", hint: "Puoi selezionare più file contemporaneamente" },
            results: { title: "Risultati", fileInfo: "File", state: "Stato", optimization: "Ottimizzazione", action: "Azione", download: "Scarica", downloadAll: "Scarica tutto", clear: "Cancella", preview: "Anteprima", remove: "Rimuovi" },
        ...
        pt: {
            ...
            dropzone: { title: "Arraste imagens aqui", description: "Arraste e solte ou clique para procurar.", formats: "Suporta JPG, PNG, WebP, AVIF, GIF, BMP, TIFF, SVG, ICO, HEIC, JPEG 2000, JPEG XL, RAW", hint: "Você pode selecionar vários arquivos de uma vez" },
            results: { title: "Resultados", fileInfo: "Arquivo", state: "Estado", optimization: "Otimização", action: "Ação", download: "Baixar", downloadAll: "Baixar tudo", clear: "Limpar", preview: "Visualizar", remove: "Remover" },
