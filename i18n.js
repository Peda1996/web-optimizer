...
const i18n = {
    ...
    fallbackTranslations: {
        en: {
            ...
            dropzone: { title: "Drop images here", description: "Drag & drop files or click to browse.", formats: "Supports JPG, PNG, WEBP, AVIF, BMP, GIF", hint: "You can select multiple files at once" },
        ...
        de: {
            ...
            dropzone: { title: "Bilder hier ablegen", description: "Dateien hierher ziehen oder klicken zum Durchsuchen.", formats: "Unterstützt JPG, PNG, WEBP, AVIF, BMP, GIF", hint: "Sie können mehrere Dateien gleichzeitig auswählen" },
        ...
        fr: {
            ...
            dropzone: { title: "Déposez les images ici", description: "Glissez-déposez ou cliquez pour parcourir.", formats: "Supporte JPG, PNG, WEBP, AVIF, BMP, GIF", hint: "Vous pouvez sélectionner plusieurs fichiers à la fois" },
        ...
        es: {
            ...
            dropzone: { title: "Arrastra imágenes aquí", description: "Arrastra y suelta o haz clic para explorar.", formats: "Soporta JPG, PNG, WEBP, AVIF, BMP, GIF", hint: "Puedes seleccionar varios archivos a la vez" },
        ...
        it: {
            ...
            dropzone: { title: "Trascina le immagini qui", description: "Trascina e rilascia o clicca per sfogliare.", formats: "Supporta JPG, PNG, WEBP, AVIF, BMP, GIF", hint: "Puoi selezionare più file contemporaneamente" },
        ...
        pt: {
            ...
            dropzone: { title: "Arraste imagens aqui", description: "Arraste e solte ou clique para procurar.", formats: "Suporta JPG, PNG, WEBP, AVIF, BMP, GIF", hint: "Você pode selecionar vários arquivos de uma vez" },
